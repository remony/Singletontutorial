var ScrollDirective = angular.module('MrPlan.directives.Widget-Directive', ['MrPlan.config']);

ScrollDirective.directive('scrollPosition', function($window, $timeout, $parse) {
    return function(scope, element, attrs) {
        ...
        var direction, index, model, scrollAnimationFunction, tmpYOffset = 0, tmpXOffset = 0;
